...
/*
    ...
    Cmdline:
        sokol-shdc --input ./cube.glsl --output ./cube.glsl.h --slang glsl430:glsl300es --format sokol_impl
...
*/
static const uint8_t cube_vs_source_glsl430[309] = {
...
*/
static const uint8_t cube_fs_source_glsl430[135] = {
...
*/
static const uint8_t cube_vs_source_glsl300es[291] = {
...
const sg_shader_desc* cube_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            valid = true;
            desc.vertex_func.source = (const char*)cube_vs_source_glsl430;
            desc.vertex_func.entry = "main";
            desc.fragment_func.source = (const char*)cube_fs_source_glsl430;
