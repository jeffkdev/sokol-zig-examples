...
Some of the Sokol examples running in Zig 0.6.0+cf750a58d (April 2020). Intended to be used as a reference or starting point for anyone looking to use Zig make games. Working platforms:
 - Windows (OpenGL)
 - MacOS (OpenGL)
